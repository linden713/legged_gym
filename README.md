...
cd legged_gym/legged_gym/scipts
...
#method 1
#假设你想加载的model路径为:/home/xxxx/competition/legged_gym/logs/rough_go2/Aug20_20-xxxx/model_100.pt
python play.py --task=go2 --load_run=/home/xxxx/xxx/competition/legged_gym/logs/rough_go2/Aug20_20-xxxx --resume --checkpoint=100 --num_envs=32


#
## load_run: 将路径修改为你想play的model_xxx.pt文件的所在路径
## check_point:选择一个pt,为model_xxx.pt的数字xxxmodel_100.pt,就赋值--check_point=100

#method 2
#假设你想加载的model路径为:/home/xxxx/competition/legged_gym/logs/rough_go2/Aug20_20-xxxx/model_100.pt
#直接在go2_config.py文件中Go2RoughCfgPPO.runner修改:
        resume = TRUE
        load_run = "/home/xxxx/xxx/competition/legged_gym/logs/rough_go2/Aug20_20-xxxx"  -1 = last run
        checkpoint = 100 # -1 = last saved model
#然后运行
python play.py --task=go2  --resume --num_envs=32
